...
Revision ID: 60c7bab70a03
Revises: e23adaa9fef7
Create Date: 2025-07-31 16:06:21.275808
...
revision: str = '60c7bab70a03'
down_revision: Union[str, None] = 'e23adaa9fef7'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['function_id'], ['automation.function.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='automation'
    )
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('programming_language_id', sa.UUID(), nullable=False),
    sa.Column('version', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['programming_language_id'], ['automation.programming_language.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='automation'
    )
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('quality_description', sa.String(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['child_group_id'], ['data_sources.data_source_group.id'], ),
    sa.ForeignKeyConstraint(['parent_group_id'], ['data_sources.data_source_group.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='data_sources'
    )
    ...
    sa.ForeignKeyConstraint(['context_id'], ['orchestrator.context.id'], ),
    ...
    sa.Column('analysis_plan', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('programming_language_version_id', sa.UUID(), nullable=False),
    sa.Column('setup_script_path', sa.String(), nullable=False),
    sa.Column('config_script_path', sa.String(), nullable=False),
    sa.Column('input_description', sa.String(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['modality_id'], ['automation.modality.id'], ),
    sa.ForeignKeyConstraint(['owner_id'], ['auth.users.id'], ),
    sa.ForeignKeyConstraint(['programming_language_version_id'], ['automation.programming_language_version.id'], ),
    sa.ForeignKeyConstraint(['source_id'], ['automation.source.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='automation'
    )
    ...
    sa.ForeignKeyConstraint(['group_id'], ['data_sources.data_source_group.id'], ),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['data_sources.data_source.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='data_sources'
    )
    ...
    sa.Column('inference_script_path', sa.String(), nullable=False),
    sa.Column('training_script_path', sa.String(), nullable=False),
    sa.Column('inference_function_id', sa.UUID(), nullable=False),
    sa.Column('training_function_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['inference_function_id'], ['automation.function.id'], ),
    sa.ForeignKeyConstraint(['model_id'], ['automation.model.id'], ),
    sa.ForeignKeyConstraint(['task_id'], ['automation.task.id'], ),
    sa.ForeignKeyConstraint(['training_function_id'], ['automation.function.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='automation'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['group_id'], ['data_objects.object_group.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='data_objects'
    )
    ...
    sa.ForeignKeyConstraint(['feature_name'], ['data_objects.feature.name'], ),
    sa.ForeignKeyConstraint(['group_id'], ['data_objects.object_group.id'], ),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['data_sources.file_data_source.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='data_sources'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['context_id'], ['orchestrator.context.id'], ),
    sa.ForeignKeyConstraint(['conversation_id'], ['orchestrator.conversation.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='orchestrator'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['data_object_id'], ['data_objects.data_object.id'], ),
    sa.ForeignKeyConstraint(['function_id'], ['automation.function.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='automation'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['derived_object_id'], ['data_objects.data_object.id'], ),
    sa.ForeignKeyConstraint(['id'], ['data_objects.data_object.id'], ),
    sa.ForeignKeyConstraint(['original_object_id'], ['data_objects.data_object.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='data_objects'
    )
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['feature_name'], ['data_objects.feature.name'], ),
    sa.ForeignKeyConstraint(['tabular_file_id'], ['data_sources.tabular_file_data_source.id'], ),
    ...
    sa.ForeignKeyConstraint(['aggregation_id'], ['data_objects.time_series_aggregation.id'], ),
    sa.ForeignKeyConstraint(['id'], ['data_objects.data_object.id'], ),
    sa.ForeignKeyConstraint(['time_series_id'], ['data_objects.time_series.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='data_objects'
    )

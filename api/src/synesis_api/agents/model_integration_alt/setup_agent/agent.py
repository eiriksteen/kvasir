...
from synesis_api.agents.model_integration_alt.setup_agent.prompt import SETUP_SYSTEM_PROMPT
...
from synesis_api.agents.model_integration_alt.history_processors import keep_only_most_recent_script, summarize_message_history

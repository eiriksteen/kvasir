...
from synesis_api.modules.model_integration.agent.inference_agent.prompt import INFERENCE_SYSTEM_PROMPT
...
from synesis_api.modules.model_integration.agent.output_structures import get_validation_code

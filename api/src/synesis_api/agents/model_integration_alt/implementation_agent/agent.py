...
from synesis_api.agents.model_integration_alt.implementation_agent.prompt import IMPLEMENTATION_SYSTEM_PROMPT
from synesis_api.agents.model_integration_alt.shared_tools import (
    get_repo_info,
    get_repo_structure,
    get_file_content,
    write_script,
    ...
    add_script_lines,
    delete_script_lines,
    get_base_config_definition_code,
)
from synesis_api.agents.model_integration_alt.prepare_tools import filter_tools
from synesis_api.agents.model_integration_alt.history_processors import keep_only_most_recent_script
from synesis_api.utils import run_python_code_in_container, remove_line_numbers_from_script
from synesis_api.agents.model_integration_alt.output_structures import get_supported_tasks, get_supported_modalities, get_validation_code
from synesis_api.agents.model_integration_alt.synthetic_data_code import get_synthetic_data, get_synthetic_config
...
class ImplementationPlanningOutput(BaseModel):

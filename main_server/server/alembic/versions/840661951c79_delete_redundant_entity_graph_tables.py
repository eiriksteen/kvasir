...
def upgrade() -> None:
    ...
    op.add_column('data_source_in_analysis', sa.Column('created_at', sa.DateTime(
        timezone=True), nullable=False), schema='entity_graph')
    op.add_column('data_source_in_analysis', sa.Column('updated_at', sa.DateTime(
        timezone=True), nullable=False), schema='entity_graph')
    op.add_column('dataset_from_data_source', sa.Column('created_at', sa.DateTime(
        timezone=True), nullable=False), schema='entity_graph')
    op.add_column('dataset_from_data_source', sa.Column('updated_at', sa.DateTime(
        timezone=True), nullable=False), schema='entity_graph')
    op.add_column('dataset_in_analysis', sa.Column('created_at', sa.DateTime(
        timezone=True), nullable=False), schema='entity_graph')
    op.add_column('dataset_in_analysis', sa.Column('updated_at', sa.DateTime(
        timezone=True), nullable=False), schema='entity_graph')
    op.add_column('model_instantiated_in_analysis', sa.Column(
        'created_at', sa.DateTime(timezone=True), nullable=False), schema='entity_graph')
    op.add_column('model_instantiated_in_analysis', sa.Column(
        'updated_at', sa.DateTime(timezone=True), nullable=False), schema='entity_graph')
...
def downgrade() -> None:
    ...
    op.drop_column('model_instantiated_in_analysis',
                   'updated_at', schema='entity_graph')
    op.drop_column('model_instantiated_in_analysis',
                   'created_at', schema='entity_graph')
    ...
    op.drop_column('dataset_from_data_source',
                   'updated_at', schema='entity_graph')
    op.drop_column('dataset_from_data_source',
                   'created_at', schema='entity_graph')

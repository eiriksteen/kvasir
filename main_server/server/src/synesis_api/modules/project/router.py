...
from synesis_api.modules.project.service import get_projects_service, Projects
from synesis_api.modules.project.schema import Project, ProjectCreate, ProjectViewPortUpdate

...
from synesis_api.modules.data_objects_old.service.metadata_service import (
    create_dataset,
    get_user_datasets,
    get_object_groups
)
from synesis_api.modules.data_objects_old.service.raw_data_service import get_time_series_payload_data_by_id
...
@router.get("/datasets", response_model=List[DatasetWithObjectGroupsAndFeatures])

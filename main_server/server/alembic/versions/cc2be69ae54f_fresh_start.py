...
def upgrade() -> None:
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('type', sa.String(), nullable=False),
    sa.Column('args_dataclass_name', sa.String(), nullable=False),
    sa.Column('input_dataclass_name', sa.String(), nullable=False),
    sa.Column('output_dataclass_name', sa.String(), nullable=False),
    sa.Column('output_variables_dataclass_name', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("type IN ('inference', 'training', 'computation', 'tool')"),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_function_definition')),
    sa.UniqueConstraint('name', name=op.f('uq_function_definition_name')),
    schema='function'
    )
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_model_definition')),
    schema='model'
    )
    ...
    sa.Column('output_variables_schema', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('default_args', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_model_function')),
    schema='model'
    )
    ...
    sa.Column('args_schema', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('output_variables_schema', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('newest_update_description', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('docstring', sa.String(), nullable=False),
    sa.Column('embedding', pgvector.sqlalchemy.vector.VECTOR(dim=1536), nullable=False),
    sa.Column('filename', sa.String(), nullable=False),
    sa.Column('python_function_name', sa.String(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['definition_id'], ['function.function_definition.id'], name=op.f('fk_function_definition_id_function_definition')),
    ...
    sa.ForeignKeyConstraint(['function_id'], ['model.model_function.id'], name=op.f('fk_model_function_input_object_group_definition_function_id_model_function')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_model_function_input_object_group_definition')),
    schema='model'
    )
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("structure_id IN ('time_series', 'time_series_aggregation')"),
    sa.ForeignKeyConstraint(['function_id'], ['model.model_function.id'], name=op.f('fk_model_function_output_object_group_definition_function_id_model_function')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_model_function_output_object_group_definition')),
    schema='model'
    )
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("structure_id IN ('time_series', 'time_series_aggregation')"),
    sa.ForeignKeyConstraint(['function_id'], ['function.function.id'], name=op.f('fk_function_input_object_group_definition_function_id_function')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_function_input_object_group_definition')),
    sa.UniqueConstraint('function_id', 'name', name=op.f('uq_function_input_object_group_definition_function_id')),
    schema='function'
    )
    ...
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('output_entity_id_name', sa.String(), nullable=False),
    sa.Column('function_id', sa.UUID(), nullable=False),
    sa.Column('structure_id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("structure_id IN ('time_series', 'time_series_aggregation')"),
    sa.ForeignKeyConstraint(['function_id'], ['function.function.id'], name=op.f('fk_function_output_object_group_definition_function_id_function')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_function_output_object_group_definition')),
    sa.UniqueConstraint('function_id', 'name', name=op.f('uq_function_output_object_group_definition_function_id')),
    schema='function'
    )
    ...
    sa.Column('definition_id', sa.UUID(), nullable=False),
    sa.Column('filename', sa.String(), nullable=False),
    sa.Column('python_class_name', sa.String(), nullable=False),
    sa.Column('module_path', sa.String(), nullable=False),
    sa.Column('version', sa.Integer(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('newest_update_description', sa.String(), nullable=False),
    ...
    sa.Column('implementation_script_path', sa.String(), nullable=False),
    sa.Column('setup_script_path', sa.String(), nullable=True),
    sa.Column('model_class_docstring', sa.String(), nullable=False),
    sa.Column('training_function_id', sa.UUID(), nullable=False),
    sa.Column('inference_function_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['definition_id'], ['model.model_definition.id'], name=op.f('fk_model_definition_id_model_definition')),
    sa.ForeignKeyConstraint(['inference_function_id'], ['model.model_function.id'], name=op.f('fk_model_inference_function_id_model_function')),
    sa.ForeignKeyConstraint(['source_id'], ['model_sources.model_source.id'], name=op.f('fk_model_source_id_model_source')),
    sa.ForeignKeyConstraint(['training_function_id'], ['model.model_function.id'], name=op.f('fk_model_training_function_id_model_function')),
    sa.ForeignKeyConstraint(['user_id'], ['auth.users.id'], name=op.f('fk_model_user_id_users')),
    ...
    sa.PrimaryKeyConstraint('pipeline_id', 'function_id', name=op.f('pk_function_in_pipeline')),
    schema='pipeline'
    )
    ...
    sa.ForeignKeyConstraint(['pipeline_id'], ['pipeline.pipeline.id'], name=op.f('fk_pipeline_graph_node_pipeline_id_pipeline')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_pipeline_graph_node')),
    schema='pipeline'
    )
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("structure_id IN ('time_series', 'time_series_aggregation')"),
    sa.ForeignKeyConstraint(['pipeline_id'], ['pipeline.pipeline.id'], name=op.f('fk_pipeline_output_object_group_definition_pipeline_id_pipeline')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_pipeline_output_object_group_definition')),
    sa.UniqueConstraint('pipeline_id', 'name', name=op.f('uq_pipeline_output_object_group_definition_pipeline_id')),
    schema='pipeline'
    )
    ...
    sa.ForeignKeyConstraint(['analysis_result_id'], ['analysis.analysis_result.id'], name=op.f('fk_aggregation_object_analysis_result_id_analysis_result')),
    ...
    sa.Column('entity_metadata_df_schema', sa.String(), nullable=True),
    sa.Column('entity_metadata_df_head', sa.String(), nullable=True),
    sa.Column('feature_information_df_schema', sa.String(), nullable=True),
    sa.Column('feature_information_df_head', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['data_objects.object_group.id'], name=op.f('fk_time_series_aggregation_object_group_id_object_group')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_time_series_aggregation_object_group')),
    schema='data_objects'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['data_objects.object_group.id'], name=op.f('fk_time_series_object_group_id_object_group')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_time_series_object_group')),
    schema='data_objects'
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['auth.users.id'], name=op.f('fk_model_entity_user_id_users')),
    ...
    sa.ForeignKeyConstraint(['analysis_id'], ['analysis.analysis_object.id'], name=op.f('fk_analysis_node_analysis_id_analysis_object')),
    ...
    sa.Column('context_id', sa.UUID(), nullable=False),
    sa.Column('analysis_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['analysis_id'], ['analysis.analysis_object.id'], name=op.f('fk_analysis_context_analysis_id_analysis_object')),
    ...
    sa.Column('code_variable_name', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['object_group_id'], ['data_objects.object_group.id'], name=op.f('fk_object_group_in_pipeline_object_group_id_object_group')),
    sa.ForeignKeyConstraint(['pipeline_id'], ['pipeline.pipeline.id'], name=op.f('fk_object_group_in_pipeline_pipeline_id_pipeline')),
    sa.PrimaryKeyConstraint('pipeline_id', 'object_group_id', name=op.f('pk_object_group_in_pipeline')),
    schema='pipeline'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['dataset_id'], ['data_objects.dataset.id'], name=op.f('fk_pipeline_graph_dataset_node_dataset_id_dataset')),
    sa.ForeignKeyConstraint(['id'], ['pipeline.pipeline_graph_node.id'], name=op.f('fk_pipeline_graph_dataset_node_id_pipeline_graph_node')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_pipeline_graph_dataset_node')),
    schema='pipeline'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['from_node_id'], ['pipeline.pipeline_graph_node.id'], name=op.f('fk_pipeline_graph_edge_from_node_id_pipeline_graph_node')),
    sa.ForeignKeyConstraint(['to_node_id'], ['pipeline.pipeline_graph_node.id'], name=op.f('fk_pipeline_graph_edge_to_node_id_pipeline_graph_node')),
    sa.PrimaryKeyConstraint('from_node_id', 'to_node_id', name=op.f('pk_pipeline_graph_edge')),
    schema='pipeline'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['function_id'], ['function.function.id'], name=op.f('fk_pipeline_graph_function_node_function_id_function')),
    sa.ForeignKeyConstraint(['id'], ['pipeline.pipeline_graph_node.id'], name=op.f('fk_pipeline_graph_function_node_id_pipeline_graph_node')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_pipeline_graph_function_node')),
    schema='pipeline'
    )
    op.create_table('project_analysis',
    sa.Column('project_id', sa.UUID(), nullable=False),
    sa.Column('analysis_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['analysis_id'], ['analysis.analysis_object.id'], name=op.f('fk_project_analysis_analysis_id_analysis_object')),
    ...
    sa.ForeignKeyConstraint(['project_id'], ['project.project.id'], name=op.f('fk_run_project_id_project')),
    ...
    sa.ForeignKeyConstraint(['id'], ['pipeline.pipeline_graph_node.id'], name=op.f('fk_pipeline_graph_model_entity_node_id_pipeline_graph_node')),
    sa.ForeignKeyConstraint(['model_entity_id'], ['model.model_entity.id'], name=op.f('fk_pipeline_graph_model_entity_node_model_entity_id_model_entity')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_pipeline_graph_model_entity_node')),
    schema='pipeline'
    )
    ...
    sa.Column('analysis_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['analysis_id'], ['analysis.analysis_object.id'], name=op.f('fk_analysis_in_run_analysis_id_analysis_object')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_analysis_in_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'analysis_id', name=op.f('pk_analysis_in_run')),
    schema='runs'
    )
    ...
    sa.Column('data_source_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['data_source_id'], ['data_sources.data_source.id'], name=op.f('fk_data_source_from_run_data_source_id_data_source')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_data_source_from_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'data_source_id', name=op.f('pk_data_source_from_run')),
    schema='runs'
    )
    ...
    sa.Column('dataset_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['dataset_id'], ['data_objects.dataset.id'], name=op.f('fk_dataset_from_run_dataset_id_dataset')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_dataset_from_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'dataset_id', name=op.f('pk_dataset_from_run')),
    schema='runs'
    )
    ...
    sa.Column('dataset_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['dataset_id'], ['data_objects.dataset.id'], name=op.f('fk_dataset_in_run_dataset_id_dataset')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_dataset_in_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'dataset_id', name=op.f('pk_dataset_in_run')),
    schema='runs'
    )
    ...
    sa.Column('model_entity_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['model_entity_id'], ['model.model_entity.id'], name=op.f('fk_model_entity_from_run_model_entity_id_model_entity')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_model_entity_from_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'model_entity_id', name=op.f('pk_model_entity_from_run')),
    schema='runs'
    )
    ...
    sa.Column('model_entity_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['model_entity_id'], ['model.model_entity.id'], name=op.f('fk_model_entity_in_run_model_entity_id_model_entity')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_model_entity_in_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'model_entity_id', name=op.f('pk_model_entity_in_run')),
    schema='runs'
    )
    ...
    sa.Column('pipeline_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['pipeline_id'], ['pipeline.pipeline.id'], name=op.f('fk_pipeline_from_run_pipeline_id_pipeline')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_pipeline_from_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'pipeline_id', name=op.f('pk_pipeline_from_run')),
    schema='runs'
    )
    ...
    sa.Column('pipeline_id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['pipeline_id'], ['pipeline.pipeline.id'], name=op.f('fk_pipeline_in_run_pipeline_id_pipeline')),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_pipeline_in_run_run_id_run')),
    sa.PrimaryKeyConstraint('run_id', 'pipeline_id', name=op.f('pk_pipeline_in_run')),
    schema='runs'
    )
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['run_id'], ['runs.run.id'], name=op.f('fk_run_specification_run_id_run')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_run_specification')),
    schema='runs'
    )

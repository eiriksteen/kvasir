...
interface AddModelSourceProps {
  onClose: () => void;
  projectId: UUID;
}

export default function AddModelSource({ onClose, projectId }: AddModelSourceProps) {
    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="relative w-full max-w-2xl h-[80vh] bg-gray-950 border border-[#101827] rounded-lg shadow-2xl overflow-hidden">
        ...
        <div className="flex flex-col h-full p-4">
          <h3 className="text-xs font-mono uppercase tracking-wider text-gray-400 mb-6">Add Model Source</h3>

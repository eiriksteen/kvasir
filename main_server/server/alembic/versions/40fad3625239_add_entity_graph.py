...
def downgrade() -> None:
    ...
    op.drop_table('model_entity_in_pipeline_run', schema='entity_graph')
    ...
    op.drop_table('model_entity_supported_in_pipeline', schema='entity_graph')
    op.drop_table('model_entity_in_analysis', schema='entity_graph')

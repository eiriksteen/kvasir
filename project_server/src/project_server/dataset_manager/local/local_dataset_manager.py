...
from project_server.src.project_server.dataset_manager.abstract_dataset_manager import AbstractDatasetManager, DatasetCreate
from project_server.src.project_server.dataset_manager.dataclasses import ObjectGroupWithRawData, DatasetWithRawData
from project_server.secrets import INTEGRATED_DATA_DIR
...
class LocalDatasetManager(AbstractDatasetManager):
    ...
    async def upload_dataset(self, dataset_create: DatasetCreate) -> None:
        # Upload metadata to main server and get back dataset with raw data

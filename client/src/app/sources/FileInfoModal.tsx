...
import { X, FileText, BarChart3, FileText as FileDescription, Shield, List } from 'lucide-react';
          ...
          <div className="bg-[#0a101c]/50 border border-[#1f2937] rounded-lg">
            ...
            <div className="p-4 space-y-3">
              <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-4 space-y-2">
                ...
                <p className="text-sm text-zinc-400">Features: {dataSource.features.map((feature) => feature.name).join(", ")}</p>
              </div>

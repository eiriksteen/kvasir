...
from synesis_api.modules.model_sources.service import create_model_source, get_model_source_by_id
...
async def fetch_model_source_by_id(
    ...
    return await get_model_source_by_id(user.id, model_source_id)

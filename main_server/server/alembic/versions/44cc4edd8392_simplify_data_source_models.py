...
def upgrade() -> None:
    ...
    op.alter_column('tabular_file_data_source', 'content_preview',
                    ...
                    nullable=False,
                    schema='data_sources')
    op.create_foreign_key(op.f('fk_model_entity_implementation_model_id_model_implementation'), 'model_instantiated_implementation',
...
def downgrade() -> None:
    ...
    op.drop_constraint(op.f('fk_model_entity_implementation_model_id_model_implementation'),
                       'model_instantiated_implementation', schema='model', type_='foreignkey')
    op.create_foreign_key(op.f('fk_model_entity_implementation_model_id_model'), 'model_instantiated_implementation', 'model', [

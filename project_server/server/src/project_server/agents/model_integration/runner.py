...
from project_server.agents.model_integration.utils import (
    ...
    create_model_test_code_from_spec
)
...
class ModelIntegrationAgentRunner(RunnerBase):
    ...
    async def __call__(self, prompt_content: str) -> ModelDescription:
        ...
        try:
            ...
            structure_ids = list(set([
                input.structure_id for input in
                model_spec_output.training_function.input_object_groups +
                model_spec_output.inference_function.input_object_groups +
                model_spec_output.training_function.output_object_groups +
                model_spec_output.inference_function.output_object_groups
            ]))
            ...
            swe_runner = SWEAgentRunner(
                ...
                self.run_id,
                structure_ids_to_inject=structure_ids,
            ...
            swe_prompt = (
                ...
                "Remember to use the synthetic data description to set default values!\n\n" +
                "Go!"
            )

            swe_test_code = create_model_test_code_from_spec(
